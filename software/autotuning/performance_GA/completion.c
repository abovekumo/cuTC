...
*/
idx_t tc_main_ciss(sptensor_t* traina, sptensor_t* trainb, sptensor_t* trainc, sptensor_t* validation, sptensor_t* test, int algorithm_index, int SGD_DEFAULT_BLOCKSIZE, int SGD_DEFAULT_T_TILE_LENGTH)
{
    idx_t exectime = 0;
    ...
    case 0:
        ...
        exectime = tc_als(traina, trainb, trainc, validation, test, mats, best_mats, algorithm_index,  regularization_index, &best_rmse, &tolerance, SGD_DEFAULT_BLOCKSIZE, SGD_DEFAULT_T_TILE_LENGTH, &nbadepochs, &bestepochs, &max_badepochs);
        break;
    ...
    case 1:
        ...
        exectime = tc_sgd(traina, trainb, trainc, validation, test, mats, best_mats, aux_mats, algorithm_index,  regularization_index, learning_rate, &best_rmse, &tolerance, SGD_DEFAULT_BLOCKSIZE, SGD_DEFAULT_T_TILE_LENGTH, &nbadepochs, &bestepochs, &max_badepochs);
        break;    
    
    default:
        regularization_index = (double)CCD_REGULARIZATION;
        exectime = tc_ccd(traina, trainb, trainc, validation, test, mats, best_mats, algorithm_index, regularization_index,  &best_rmse, &tolerance, SGD_DEFAULT_BLOCKSIZE, SGD_DEFAULT_T_TILE_LENGTH, &nbadepochs, &bestepochs, &max_badepochs);
        break;
    }
