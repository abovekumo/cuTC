...
#define SGD_REGULARIZATION 1e-4
#define CCD_REGULARIZATION 100
#define ALS_REGULARIZATION 10 
#define SGD_MODIFICATIONA 1e-4
#define SGD_MODIFICATIONB 1e-4
#define SGD_MODIFICATIONC 1e-4
